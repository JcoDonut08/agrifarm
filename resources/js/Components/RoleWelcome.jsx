    ...
    return (
        <AuthenticatedLayout title={title} introduction={introduction}>
            <div className="grid gap-6 lg:grid-cols-[1fr_18rem]">
                <section className="rounded-3xl border border-forest-950/10 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-night-800 sm:p-8">
                    ...
                    <h2 className="mt-3 text-2xl font-bold tracking-tight text-forest-950 dark:text-white">{label}</h2>
                    <p className="mt-3 max-w-2xl leading-7 text-stone-600 dark:text-stone-300">{detail}</p>
                </section>
